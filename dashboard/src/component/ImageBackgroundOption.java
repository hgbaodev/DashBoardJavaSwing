...
public class ImageBackgroundOption extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        buttomImage1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background/bg_1_small.jpg"))); // NOI18N
        buttomImage1.setSelected(true);

        buttomImage2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background/bg_2_small.jpg"))); // NOI18N

        buttomImage3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background/bg_3_small.jpg"))); // NOI18N

        buttomImage4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background/bg_4_small.jpg"))); // NOI18N

        buttomImage5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background/bg_5_small.jpg"))); // NOI18N
